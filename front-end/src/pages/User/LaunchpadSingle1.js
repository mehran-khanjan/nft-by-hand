...
import bigImage1 from '../../assets/img/products/set01/10-1-main.jpg';
import bigImage2 from '../../assets/img/products/set01/1-1.jpg';
import bigImage3 from '../../assets/img/products/set01/2-1.jpg';
import bigImage4 from '../../assets/img/products/set01/11-1.jpg';

import littleImage1 from '../../assets/img/products/set01/10-1-main-163.jpg';
                        ...
                        <div className="col-12 col-lg-7">
                            ...
                            <div className="details">
                                ...
                                <div className="splide splide--details details__slider">
                                    ...
                                    <div className="splide__track">
                                        <ul className="splide__list">
                                            <li className="splide__slide" style={{width: '100%'}}>
                                                <img src={bigImage1} alt="" style={{visibility: 'visible'}}/>
                                            </li>
                                            <li className="splide__slide" style={{width: '100%'}}>
                                ...
                                <ul id="thumbnails" className="thumbnails">
                                    <li className="thumbnail is-active">
                                        <img src={littleImage1} alt=""/>
                                    </li>
                                    <li className="thumbnail">
                                        <img src={littleImage2} alt=""/>
                                    </li>
                                    <li className="thumbnail">
                                        <img src={littleImage3} alt=""/>
                                    </li>
                                    <li className="thumbnail">
                                        <img src={littleImage4} alt=""/>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="col-12 col-lg-5">
                            ...
                            <div className="description">
                                ...
                                <table className="description__table">
                                    ...
                                    <tr>
                                        <td>Material</td>
                                        <td>Khatam on Wood on Outside, thin sticks of wood</td>
                                    </tr>
                                    <tr>
                                        <td>Usages</td>
                                        <td>Chess & Backgammon Set, Decorative Crafts, Persian Gift</td>
                                    </tr>
                                    <tr>
                                        <td>Originate</td>
                                        <td>Handmade in Isfahan / Iran</td>
                                    </tr>
                                    <tr>
                                        <td>Package</td>
                                        <td>Chess plate + bag + Backgammon stones</td>
                                    </tr>
                                    <tr>
                                        <td>Status</td>
                                        <td>In Stock</td>
                                ...
                                <ul className="description__list">
                                    <li>
                                        Contract Address <span className="devices">0x6D4D...492e</span>
                                    </li>
                                    <li>
                                        Token ID <span className="required">1</span>
                                    </li>
                                    <li>
                                        Token Standard <span className="required">ERC-721</span>
                                    </li>
                                    <li>
                                        Chain <span className="required">Binance Chain</span>
                                    </li>
                                    <li>
                                        Loyalty Fee <span className="process">0%</span>
                                    </li>
                                </ul>
